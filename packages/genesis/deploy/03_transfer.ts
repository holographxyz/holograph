...
import { NetworkKeys, NetworkType, networks } from '@holographxyz/networks';
...
// This script is used to transfer funds from the deployer to another address set in the FUNDS_TRANSFER environment variable.
// This should probably be moved to the scripts folder
// Disabled for now
