...
export interface HolographGenesisInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "approveDeployer" | "deploy" | "isApprovedDeployer"
  ): FunctionFragment;
...
export interface HolographGenesis extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HolographGenesisInterface;
