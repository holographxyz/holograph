...
export interface DummyDropsPriceOracleInterface extends utils.Interface {
  functions: {
...
export interface DummyDropsPriceOracle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DummyDropsPriceOracleInterface;
