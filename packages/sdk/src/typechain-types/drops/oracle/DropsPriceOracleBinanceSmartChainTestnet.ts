...
export interface DropsPriceOracleBinanceSmartChainTestnetInterface
...
export interface DropsPriceOracleBinanceSmartChainTestnet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DropsPriceOracleBinanceSmartChainTestnetInterface;
