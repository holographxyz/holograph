...
export interface DropsPriceOraclePolygonInterface extends utils.Interface {
  functions: {
...
export interface DropsPriceOraclePolygon extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DropsPriceOraclePolygonInterface;
