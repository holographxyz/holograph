...
export interface DropsPriceOracleAvalancheInterface extends utils.Interface {
  functions: {
...
export interface DropsPriceOracleAvalanche extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DropsPriceOracleAvalancheInterface;
