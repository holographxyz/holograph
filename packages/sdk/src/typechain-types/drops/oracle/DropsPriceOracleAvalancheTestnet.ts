...
export interface DropsPriceOracleAvalancheTestnetInterface
...
export interface DropsPriceOracleAvalancheTestnet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DropsPriceOracleAvalancheTestnetInterface;
