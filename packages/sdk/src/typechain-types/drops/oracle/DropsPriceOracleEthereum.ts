...
export interface DropsPriceOracleEthereumInterface extends utils.Interface {
  functions: {
...
export interface DropsPriceOracleEthereum extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DropsPriceOracleEthereumInterface;
