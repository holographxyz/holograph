...
export interface MockHolographChildInterface extends utils.Interface {
  functions: {
    "admin()": FunctionFragment;
    "adminCall(address,bytes)": FunctionFragment;
    "emptyFunction()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "emptyFunction",
    values?: undefined
  ): string;
...
export interface MockHolographChild extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockHolographChildInterface;
  ...
  functions: {
    ...
    emptyFunction(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    emptyFunction(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    emptyFunction(overrides?: CallOverrides): Promise<PopulatedTransaction>;
