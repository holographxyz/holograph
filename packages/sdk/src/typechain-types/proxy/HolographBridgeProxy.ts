...
export interface HolographBridgeProxyInterface extends utils.Interface {
  functions: {
...
export interface HolographBridgeProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HolographBridgeProxyInterface;
