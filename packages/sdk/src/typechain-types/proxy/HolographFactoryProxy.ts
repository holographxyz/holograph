...
export interface HolographFactoryProxyInterface extends utils.Interface {
  functions: {
...
export interface HolographFactoryProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HolographFactoryProxyInterface;
