...
export interface HolographTreasuryProxyInterface extends utils.Interface {
  functions: {
...
export interface HolographTreasuryProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HolographTreasuryProxyInterface;
