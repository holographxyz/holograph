...
import {CustomERC721ABI, LazyMintABI} from '../constants/abi/develop'
...
const ABIs = [...CustomERC721ABI, ...LazyMintABI]
...
export class CustomERC721 extends HolographBaseContract {
   ...
   * @param baseURIForTokens The base URI for the 'n' number of NFTs being lazy minted, where the metadata for each of those NFTs is `${baseURIForTokens}/${tokenId}`.
   * @param data The encrypted metadata for 'delayed reveal' NFTs.
   * @param wallet Holograph wallet instance, optional param.
   * @param options The override options for the transaction.
   * @returns A transaction.
   */
