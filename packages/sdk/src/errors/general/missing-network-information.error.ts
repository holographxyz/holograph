...
export class MissingNetworkInformationError extends HolographError {
  constructor(triggerFunction?: string, cause?: Error) {
    super({
      ...
      message:
        'Missing network information. Please provide either "networks" or "provider" in the constructor arguments.',
      description: `Creating a HolographWallet instance requires either a "networks" object or a "provider" to be provided as arguments. 
