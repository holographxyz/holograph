...
export interface DropsPriceOracleArbitrumNovaInterface extends utils.Interface {
  functions: {
...
export interface DropsPriceOracleArbitrumNova extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DropsPriceOracleArbitrumNovaInterface;
