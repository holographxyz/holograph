...
export interface DropsPriceOracleOptimismTestnetGoerliInterface
...
export interface DropsPriceOracleOptimismTestnetGoerli extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DropsPriceOracleOptimismTestnetGoerliInterface;
