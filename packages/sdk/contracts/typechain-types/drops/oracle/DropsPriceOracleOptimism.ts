...
export interface DropsPriceOracleOptimismInterface extends utils.Interface {
  functions: {
...
export interface DropsPriceOracleOptimism extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DropsPriceOracleOptimismInterface;
