...
export interface LayerZeroEndpointInterfaceInterface extends utils.Interface {
  functions: {
...
export interface LayerZeroEndpointInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LayerZeroEndpointInterfaceInterface;
