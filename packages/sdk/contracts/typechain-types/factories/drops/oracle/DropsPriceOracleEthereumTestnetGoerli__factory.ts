...
import type {
  DropsPriceOracleEthereumTestnetGoerli,
  DropsPriceOracleEthereumTestnetGoerliInterface,
} from "../../../drops/oracle/DropsPriceOracleEthereumTestnetGoerli";
...
type DropsPriceOracleEthereumTestnetGoerliConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: DropsPriceOracleEthereumTestnetGoerliConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class DropsPriceOracleEthereumTestnetGoerli__factory extends ContractFactory {
  constructor(...args: DropsPriceOracleEthereumTestnetGoerliConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): Promise<DropsPriceOracleEthereumTestnetGoerli> {
    return super.deploy(
      overrides || {}
    ) as Promise<DropsPriceOracleEthereumTestnetGoerli>;
  }
  ...
  override attach(address: string): DropsPriceOracleEthereumTestnetGoerli {
    return super.attach(address) as DropsPriceOracleEthereumTestnetGoerli;
  }
  override connect(
    signer: Signer
  ): DropsPriceOracleEthereumTestnetGoerli__factory {
    return super.connect(
      signer
    ) as DropsPriceOracleEthereumTestnetGoerli__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): DropsPriceOracleEthereumTestnetGoerliInterface {
    return new utils.Interface(
      _abi
    ) as DropsPriceOracleEthereumTestnetGoerliInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as DropsPriceOracleEthereumTestnetGoerli;
  }
}
